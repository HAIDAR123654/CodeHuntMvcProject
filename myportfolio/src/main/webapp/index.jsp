  ...
  <body>
   ...
   %>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.html"><i class='uil uil-user'></i>Java Dev</a>
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <%
                       if(user!=null){
                    	   %>
                    	   <li class="nav-item">
                           <a href="admin.jsp" class="nav-link"><span data-hover="<%=user%>"><%=user %></span></a>
                           </li> 
                           <%  
                       }
                       else{
                    	   %>
                    	   <li class="nav-item">
                           <a href="admin.jsp" class="nav-link"><span data-hover="Admin">Admin</span></a>
                       </li>
                       <%
                       }
                    %>
                    ...
                    <div class="about-text">
                        ...
                        <h1 class="animated animated-text">
                                ...
                                <div class="animated-info">
                                    <span class="animated-item">Haidar Ali</span>
                                    <span class="animated-item">Java Developer</span>
                                    <span class="animated-item">Tester</span>
                                </div>
                        </h1>
                        ...
                        <div class="custom-btn-group mt-4">
                         <!--  <a href="/myportfolio/Resume" class="btn mr-lg-2 custom-btn"><i class='uil uil-file-alt'></i> Download Resume</a>  -->
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-lg-5 col-12">
            <div class="google-map w-100">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5201.665243032097!2d75.84084930224391!3d22.797543837168963!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962fd0bbd8c1735%3A0x4010adec7b446fd1!2sAurobindo%20Hospital!5e0!3m2!1sen!2sin!4v1705856098331!5m2!1sen!2sin" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            ...
            <div class="contact-info d-flex justify-content-between align-items-center py-4 px-lg-5">
                ...
                <ul class="social-links">
                     ...
                     <li><a href="https://www.instagram.com/ali01_haidar?igsh=cTNpeWx3MTdkYTRl" class="uil uil-instagram" data-toggle="tooltip" data-placement="left" title="Instagram"></a></li>
              ...
              <form action="Message" method="post">
                <div class="row">
                  ...
                  <div class="ml-lg-auto col-lg-5 col-12">
                    <input type="submit" class="form-control submit-btn" id="myform" value="Send Button">
                  </div>
                </div>
              </form>
            </div>
